...
class View_CRM_Order_Process_History_On_P7(unittest.TestCase):
    ...
    def testPreview_View_CRM_Order_Process_History_On_P7(self):
        ...
        driver.get(P7URL)
        time.sleep(3)
        self.assertIn(u'登录 Order and Service Management 6', driver.title)
        ...
        self.assertIn(u'关于 Order and Service Management 6',driver.title)
        #Login
        ...
        InputText.clear()
        time.sleep(2)
        CRMOrder = raw_input("Please input CRM Order number:")
        ...
        if CRMOrder in driver.page_source:
            ...
            self.assertIn(u'流程历史',driver.title)
            time.sleep(2)
